...
# Function to fetch a random Dutch Wikipedia article
...
def save_dutch_articles(filename, article_count=10):
...
if __name__ == "__main__":
    output_file = "dutch_wikipedia_articles.txt"
    num_articles = 200  # Change this to the desired number of articles
    save_dutch_articles(output_file, article_count=num_articles)
    print(f"Saved {num_articles} Dutch Wikipedia articles to {output_file}")
